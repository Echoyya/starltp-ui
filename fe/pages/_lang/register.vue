                ...
                <div class="login-content">
                    ...
                    <div class="reg-form">
                        ...
                        >
                            ...
                            <el-form-item style="margin-bottom: 0;float: left; width: 25%">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >{{ countryConfig[item] }}</span>
                                    </el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item
                                prop="phone_number"
                                style="margin-bottom: 0;float: right; width: 73%"
                            >
                                <el-input
                                    v-model="ruleForm.phone_number"
                                    :placeholder="$t('register.inputTelNum')"
                                ></el-input>
                            </el-form-item>
                            <el-form-item style="margin-bottom: 0; clear: both">
                                <div style="float: right;margin: 0 5px 0 auto">
                                    <nuxt-link
                                        :to="{path:$i18n.path('registerEmail'), query:{redirect: redirect}}"
                                    >{{$t('register.registerEmail')}}></nuxt-link>
                                </div>
                            </el-form-item>
                            ...
                            <el-form-item prop="verification_code">
                                <el-input
                                    ...
                                    type="text"
                                    class="validate-code"
                                    :placeholder="$t('register.inputVerificationCode')"
                                />
                                <el-button
                                    class="get-validate"
                                    :disabled="sendMsgDisabled"
                                    @click="getCode"
                                >{{$t('register.getVerificationCode')}}{{ countdown === 0 ? '' : countdown + 's' }}</el-button>
                            </el-form-item>
                            <el-form-item>
                                <el-button
                                    class="register-btn"
                        ...
                        <div class="reg-login">
                            ...
                            >{{$t('register.loginExistAccount')}}></nuxt-link>
                        </div>
                    </div>
                </div>
            </div>
