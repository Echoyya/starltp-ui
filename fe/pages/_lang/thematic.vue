<template>
    <div class="container thematic">
        <banner
            :title="$t('menu.thematic')"
            :step="step"
            :banner="banner"
            :info="$t('order.thematicInfo')"
        />
        <div class="form">
            <el-form
                ref="thematicForm"
            ...
            >
                ...
                >
                    ...
                    <i class="iconfont">&#xe60c;</i>
                    <el-select v-model="thematicForm.language.targetLanguages" collapse-tags>
                        <el-option
                            v-for="item in config.languages"
                            :key="item.value"
                            :label="$t(item.label)"
                ...
                <el-form-item :label="$t('order.deliverDate')" prop="deliverDate">
                    <el-date-picker
                        v-model="thematicForm.deliverDate"
                        type="datetime"
                ...
                <el-form-item :label="$t('order.claim')" prop="request">
                    <el-input v-model="thematicForm.request" type="textarea"></el-input>
                </el-form-item>
                <el-form-item class="agreement" prop="read">
                    <el-checkbox v-model="thematicForm.read" true-label="true" false-label></el-checkbox>
...
export default {
    ...
    // },
    computed: {
        ...mapState(['token', 'thematicForm'])
    },

    methods: {
        ...mapMutations(['RESET_THEMATICFORM']),
