<template>
    <div class="container dubbing">
        <banner
            :title="$t('menu.dubbing')"
            :step="step"
            :banner="banner"
            :info="$t('order.dubbingInfo')"
        />
        <div class="form">
            <el-form
                ref="dubbingForm"
            ...
            >
                ...
                >
                    ...
                    <i class="iconfont">&#xe60c;</i>
                    <el-select
                        v-model="dubbingForm.language.targetLanguages"
                        :multiple="true"
                        collapse-tags
                    >
                        <el-option
                ...
                <el-form-item :label="$t('order.type')" prop="areaOfField" :required="true">
                ...
                <el-form-item :label="$t('order.deliverDate')" prop="deliverDate">
                    <el-date-picker
                        v-model="dubbingForm.deliverDate"
                        type="datetime"
                ...
                <el-form-item :label="$t('order.claim')" prop="request">
                    <el-input v-model="dubbingForm.request" type="textarea"></el-input>
                </el-form-item>
                <el-form-item class="agreement" prop="read">
                    <el-checkbox v-model="dubbingForm.read" true-label="true" false-label></el-checkbox>
...
export default {
    ...
    computed: {
        ...mapState(['token', 'dubbingForm'])
    },
    methods: {
        ...mapMutations(['RESET_DUBBINGFORM']),
