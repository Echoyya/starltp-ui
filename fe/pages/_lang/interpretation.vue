<template>
    <div class="container interpretation">
        ...
        <div class="form">
            <el-form ref="interpretationForm" :model="interpretationForm" :rules="rules" :inline-message.boolean="true" label-width="250px" class="form-body">
                ...
                <el-form-item :label="$t('order.timeLimit')" prop="time" :rules="timeRules" :required.boolean="true">
                    <el-date-picker v-model="interpretationForm.time" :picker-options="pickerOptions1" type="datetimerange" :range-separator="$t('order.to')" :start-placeholder="$t('order.starTime')" :end-placeholder="$t('order.endTime')" @change="timeChange"></el-date-picker>
                    <span v-if="timeShow" class="el-upload__tip">{{timeShow}}</span>
                </el-form-item>
                <el-form-item :label="$t('order.claim')" prop="request">
                    <el-input v-model="interpretationForm.request" type="textarea" :rows.number="5"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button :loading="loading" @click="submitForm('interpretationForm')">{{$t('menu.submit')}}</el-button>
                </el-form-item>
            </el-form>
        </div>
